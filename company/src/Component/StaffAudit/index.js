...
class StaffAudit extends Component {
     constructor(){
        super()
        this.state={
          data :[],
    ...
    handleOk(){
      ...
      axios.post(window.config.host+'/admin/partner/approve', Qs.stringify(postmsg),{
        headers:{
    ...
    render(){
        return (<div className="express">
          <div className="DetailList">员工审核</div>
          ...
          <Modal title="个人详情" visible={this.state.visible} okText="确认" cancelText="取消" onOk={this.handleOk.bind(this)} onCancel={this.handleCancel.bind(this)}>
              <div className='parter-info'>
                ...
                合同照片：<img alt='' className={this.state.pic3?'upload-pic':''} data-id='3' onClick={this.clickPic.bind(this)}   src={this.state.partner.contract}/>
                </div>
                ...
                <div className="item" style={this.state.passButton?{display:'block'}:{display:'none'}}>
                  ...
                  <img alt='' className={this.state.pic4?'upload-pic':''} data-id='4' onClick={this.clickPic.bind(this)} src={this.state.contractUrl}/>
                </div>
